...
export default function Matches() {
  ...
  return (
    <div className="p-2 sm:p-4 md:p-8 bg-neutral-950 min-h-screen text-neutral-200 font-fifa flex flex-col">
      <div className="max-w-6xl mx-auto w-full mb-4 sm:mb-8 text-center bg-neutral-800 border border-neutral-600 rounded-xl p-4 sm:p-6 shadow-2xl relative overflow-hidden shrink-0">
